  ...
  return (
    <div className='-mb-8 flex flex-col font-caveat md:mb-0 md:flex-row'>
      <div className='color-[#8B8B8B] z-20 flex h-[280px] w-[230px] -rotate-6 flex-col overflow-hidden bg-white p-4 shadow-md shadow-dark/50'>
        <div className='h-[200px] w-full overflow-hidden border-[1px] border-dark/30'>
          <Image
            height={220}
        ...
        <div className='relative top-[5px] flex w-full flex-1 items-center justify-center text-4xl font-medium text-black'>
          2013
        </div>
      </div>
